...
@synthesize bannerIsVisible,bannerView, NOV11, JUN12;
@synthesize activity ;
...
-(void) segmentAction:(id)sender {
    ...
    
    {
     ...
     //   [self.mapView setHidden:YES];
        ...
        NSString *documentsDirectory = [paths objectAtIndex:0];
        NSString *finalPath = [documentsDirectory stringByAppendingPathComponent: 
                               [NSString stringWithFormat: @"%@.plist",@"Property List3"] ];
        //  [finalPath retain];
...
//   event2=nil;
 ...
 //  NSLog(@"Outside the loop");
    ...
    NSArray * segmentItems= [NSArray arrayWithObjects: @"Nov 2011", @"Jun 2012",@"Nov 2012", nil];
